...
## Billing, HR, and Onboarding Fixes

### Plans & Billing Layout Fix
- [x] Fix overlapping layout on Plans & Billing page
- [x] Add ability to edit plan pricing from Platform Command Center
- [x] Set standard pricing: Starter $499, Professional $999, Enterprise $1,999, Sovereign Custom
- [x] Ensure pricing changes persist and reflect across the platform

### HR Hub Delete Bug
- [x] Fix employee deletion in HR Hub People section (was cache invalidation issue — delete succeeds but list didn't refresh)
- [x] Fix payroll record deletion in HR Hub Payroll section
- [x] Test delete functionality works end-to-end

### Full Onboarding Test (All Plan Tiers)
- [ ] Provision test account on Starter plan ($499)
- [ ] Provision test account on Professional plan ($999)
- [ ] Provision test account on Enterprise plan ($1,999)
- [ ] Provision test account on Sovereign plan (Custom)
- [ ] Verify each account onboards correctly
- [ ] Verify permissions are correct for each tier
- [ ] Verify access levels above each tier have correct permissions
- [ ] Document findings and issues


## Plans & Billing Page Fix + Impersonation + Tier Testing
- [x] Fix Plans & Billing page layout (add p-8 padding wrapper)
- [x] Verify pricing tiers display correctly: $499, $999, $1,999, Custom
- [x] Verify edit icons on each plan card for custom pricing
- [x] Fix admin-hub.ts data scoping — scope dashboardOverview, listAllIntegrations, listAllFeatureToggles to user's account orgs
- [x] Add ownership checks to getOrgDetail, updateOrgStatus, updateMemberRole, removeMember
- [x] Add platform-only guards to updateAccountStatus, updateAccountMrr, updateAccountHealth
- [x] Add ownership checks to toggleFeature, updateFeaturePlan, getOrgAvailableFeatures
- [x] Add ownership checks to uploadOrgLogo and updateIntegration
- [x] Build Impersonate User feature (platform-owner only)
- [x] Create /api/impersonate REST endpoint for server-side cookie setting
- [x] Add return-to-admin flow (platform owner token verification)
- [x] Add Impersonate User page to Admin Hub sidebar (platform-only)
- [x] Create test accounts for each plan tier (Sarah Chen/Starter, Marcus Webb/Professional, Fatima Al-Rashid/Enterprise, James Whitfield/Sovereign)
- [x] Set onboarding as completed for all test users
- [x] Verify Sarah Chen (Starter) — dashboard, sidebar, permissions correct
- [x] Verify Marcus Webb (Professional) — dashboard, sidebar, permissions correct
- [x] Verify Fatima Al-Rashid (Enterprise) — dashboard, sidebar, permissions correct
- [x] Verify James Whitfield (Sovereign) — dashboard, sidebar, permissions correct
- [x] Verify no test user can see Admin or Platform sidebar links
- [x] Fix architecture guardrails test (recordLogin ctx destructuring)
- [x] All tests passing (1,182 passed)
- [ ] HR Hub employee deletion — backend works (200 OK, records deleted), may be a frontend cache/redirect timing issue
