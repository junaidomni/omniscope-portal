...
## v58 — Vault Cleanup, Import Fix, Document Viewer Fix

### Bug Fixes
- [x] Fix internal document viewer not loading files (added exportFileBinary for Drive PDFs)
- [x] Fix import button to only import files in current folder, not entire drive
- [x] Fix nested button DOM error in Vault.tsx

### Vault Data Cleanup
- [x] Remove all Pinnacle Partners / insurance-related documents from Vault
- [x] Remove duplicates and junk files (Little Miracles, Population Science, etc.)
- [x] Properly tag NCNDAs to the correct contacts/companies
- [x] Link all 85 remaining documents to appropriate entities (96 entity links)
- [x] Ensure all documents have proper categories and entity links

### Vault UX Improvements
- [x] Show entity tags inline in document list (gold pills for companies, blue for contacts)
- [x] Add collection counts on collection cards (Company Repository 7, Counterparty Files 33, etc.)
- [x] Format subcategories properly (Title Case instead of ALL_CAPS_UNDERSCORES)
- [x] Entity tags in both list and grid views
- [x] Added getCollectionCounts db helper and tRPC procedure
- [x] Enhanced listDocuments and getRecentDocuments to include entity link data with names
- [x] All 938 tests passing across 37 files
